...
library(scDown)
nDim <- 30
seurat_obj <- readRDS(file=system.file("extdata", "10X43_1_spliced_unspliced.rds", package="scDown"))
species <- "mouse"
...
knitr::include_graphics("./monocle/images/pseudotime/umap_celltypes_transferUMAP_TRUE.png")
...
knitr::include_graphics("./monocle/images/pseudotime/umap_partitions_transferUMAP_TRUE.png")
...
knitr::include_graphics("./monocle/images/pseudotime/umap_trajectory_transferUMAP_TRUE.png")
...
knitr::include_graphics("./monocle/images/pseudotime/umap_pseudotime_potency.png")
...
knitr::include_graphics("./monocle/images/DEG/significant_by_trajectory_gene_featurePlot.png")
...
knitr::include_graphics("./monocle/images/DEG/significant_by_trajectory_genesInPseudotime.png")

```

The set of the trajectory-variable genes is further grouped into modules using Louvain community analysis. The clustering information is exported in a csv file (`monocleDEG_by_trajectory_moduleInformation.csv`).
...
knitr::include_graphics("./monocle/images/cellDistribution/cell_distribution_density.png")
...
knitr::include_graphics("./monocle/images/cellDistribution/celltype_distribution_histogram.png")
...
knitr::include_graphics("./monocle/monocle/images/pseudotime/umap_celltypes_transferUMAP_TRUETRUE_12.png")
...
knitr::include_graphics("./monocle/monocle/images/pseudotime/umap_pseudotime_potency_12.png")
...
knitr::include_graphics("./monocle/monocle/images/cellDistribution/cell_distribution_density.png")
...
knitr::include_graphics("./monocle/monocle/images/cellDistribution/celltype_distribution_histogram.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_age.days.+trajectory_12_35_featurePlot.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_age.days.+trajectory_12_35_genesInPseudotime.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_age.days._featurePlot.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_age.days._violinPlot.png")
...
knitr::include_graphics("./monocle/monocle/images/pseudotime/umap_trajectory_transferUMAP_TRUE_Granule immature_Granule mature.png")
...
knitr::include_graphics("./monocle/monocle/images/pseudotime/umap_pseudotime_potency_Granule immature_Granule mature.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_trajectory_gene_featurePlot_Granule immature_Granule mature.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_trajectory_genesInPseudotime_Granule immature_Granule mature.png")
...
knitr::include_graphics("./monocle/monocle/images/DEG/significant_by_trajectory_moduleHeatmap_Granule immature_Granule mature.png")
...
knitr::include_graphics("./monocle/monocle/images/cellDistribution/celltype_distribution_density_Granule immature_Granule mature.png")
...
knitr::include_graphics("./monocle/monocle/images/cellDistribution/celltype_distribution_histogram_Granule immature_Granule mature.png")
