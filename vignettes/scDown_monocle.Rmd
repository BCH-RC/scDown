...
```{r, message = FALSE,eval=FALSE}
library(scDown)
run_monocle3(seurat = seurat_obj,
             species = species,
             nDim = nDim,
...
## Construction and visulization of single-cell trajectories
...
# Comparison of trajectory between different groups
...
The UMAP plot shows the different cell types in the data at timepoint 35.
```{r, echo = FALSE, eval = TRUE, out.width = "80%", out.height = "70%"}

knitr::include_graphics("./monocle3_figures/umap_celltypes_transferUMAP_TRUETRUE_35.png")
...
run_monocle3(seurat_obj=seurat_obj,
             ...
             condition_metadata=condition_metadata,
             deg_method = "quasipoisson",
             metadata_deg_model = metadata_deg_model,
             output_dir = output_dir)
