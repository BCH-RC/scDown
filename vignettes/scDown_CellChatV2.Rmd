...
# System information
os <- Sys.info()["sysname"]
os_version <- system("sw_vers", intern = TRUE)
cat("Operating System:", os, os_version, "\n")
cpu <- system("sysctl -n machdep.cpu.brand_string", intern = TRUE)
cat("CPU Info:", cpu, "\n")
memory <- system("sysctl -n hw.memsize", intern = TRUE)
memory_gb <- as.numeric(memory) / (1024^3)
cat("Memory Info:", round(memory_gb, 2), "GB\n")
...
#### Aggregated circle plot for significant pathways
