...
To speed up the analysis for large data sets with multiple comparison we apply parallel computation for `scDown::run_scPropotion()` function. The total running time for the sample data is ~ 12.2 seconds. 
