...
create_dir <- function(dir_scproportion) {

  subdirectories <- c(file.path(dir_scproportion, "scproportion", "images"),
                      file.path(dir_scproportion, "scproportion", "results"))
  ...
  return(file.path(dir_scproportion, "scproportion"))
}
...
#' @param dir_scproportion path to save the figures 
...
generate_figure <- function(prop_test.i, output.format="png",comparisons_condition, dir_scproportion=".", cluster_col, i) {
